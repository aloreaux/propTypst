...
export default async function compile(inputRaw, outputRaw = undefined, options = {}) {
    ...
    if (options.flamegraph != null)
        opts.push("--flamegraph", options.flamegraph ? pathOrFileURLToPath(options.flamegraph) : undefined);
