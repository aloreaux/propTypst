...
import { type BeforeBuildFn, type InitOptions } from '../options.init.mjs';
...
export declare class TypstSnippet {
     ...
     */
    vector(o?: SweetCompileOptions): Promise<Uint8Array | undefined>;
    /**
     * Compile the document to PDF format.
     * See {@link SweetCompileOptions}.
     */
    pdf(o?: SweetCompileOptions): Promise<Uint8Array | undefined>;
    /**
